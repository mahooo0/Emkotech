                                            ...
                                            <div className="flex flex-col mt-7 w-full text-base max-md:max-w-full">
                                                <div className="flex flex-col w-full text-black text-opacity-60 max-md:max-w-full">
                                                    <div className="flex flex-col w-full rounded-2xl max-md:max-w-full">
                                                        <div className="overflow-hidden px-5 py-5 w-full bg-white border border-solid border-black border-opacity-10 rounded-[100px] max-md:max-w-full">
                                                            Ad və soyad
                                                        </div>
                                                    </div>
                                                    <div className="flex flex-col mt-3 w-full rounded-2xl text-black text-opacity-60 max-md:max-w-full">
                                                        <div className="overflow-hidden px-5 py-5 w-full bg-white border border-solid border-black border-opacity-10 rounded-[100px] max-md:max-w-full">
                                                    ...
                                                    <div className="flex flex-col mt-3 w-full rounded-2xl text-black text-opacity-80 max-md:max-w-full">
                                                        <div className="flex overflow-hidden flex-col justify-center px-5 py-4 w-full bg-white border border-solid border-black border-opacity-10 rounded-[100px] max-md:max-w-full">
                                                            <div className="flex gap-10 justify-between items-center">
                                                                ...
                                                                <img
                                                                    loading="lazy"
                                                                    src="https://cdn.builder.io/api/v1/image/assets/TEMP/badd2598802fd9f768c284019317f9cbc95cbab12fe1b5d91b7b6f6321eb5355?placeholderIfAbsent=true&apiKey=2d5d82cf417847beb8cd2fbbc5e3c099"
                                                                    className="object-contain shrink-0 self-stretch my-auto w-6 aspect-square"
                                                                />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="flex flex-col mt-3 w-full whitespace-nowrap rounded-2xl min-h-[111px] max-md:max-w-full">
                                                        <div className="overflow-hidden px-5 pt-4 pb-20 w-full bg-white rounded-3xl border border-solid border-black border-opacity-10 max-md:max-w-full">
                                                            Qeyd
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="gap-2.5 self-stretch px-7 py-3.5 mt-7 w-full font-medium text-white whitespace-nowrap bg-blue-600 rounded-2xl max-md:px-5 max-md:max-w-full">
                                                    Göndər
                                                </div>
                                            </div>
                                        </div>
