            ...
            <div className="flex gap-5 max-md:flex-col">
                ...
                <section className="flex flex-col ml-5 w-6/12 max-md:ml-0 max-md:w-full lg:pr-[100px] pr-0">
                    <div className="flex flex-col items-start mt-10 w-full max-md:max-w-full">
                        ...
                        <p className="self-stretch mt-9 text-base text-neutral-800 max-md:mr-1 max-md:max-w-full">
                            Introducing the 2nd Generation Essential Camera, now
                            offered in both 2K and HD options. Experience
                            exceptional smart home security with unbeatable
                            value and price.
                            <br />
                            <br />
                            Product includes: 30-day trial of an Arlo Secure
                            Plan. Paid Subscription required to divtain premium
